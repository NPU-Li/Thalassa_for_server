...
*     (CIO-based) RA are related simply through the Earth rotation angle
*     and the site longitude.  "Observed" RA,Dec or HA,Dec thus means
*     the position that would be seen by a perfect equatorial with its
*     polar axis aligned to the Earth's axis of rotation.
*
