...
*  Speed of light (au per day)
      ...
      DOUBLE PRECISION R, PU(3), VR, UR(3), VT, UT(3), BETT, BETR, D, W,
...
*  Isolate the radial component of the velocity (au/day, inertial).
      CALL iau_PN ( PV(1,1), R, PU )
      CALL iau_PDP ( PU, PV(1,2), VR )
      CALL iau_SXP ( VR, PU, UR )
...
*  Compute observed radial velocity vector (au/d).
      CALL iau_SXP ( C*(BETR-DEL)/D, PU, USR )
