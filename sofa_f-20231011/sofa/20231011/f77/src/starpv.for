...
*  Maximum number of iterations for relativistic solution
      ...
      INTEGER IWARN
      DOUBLE PRECISION W, R, RD, RAD, DECD, V, PU(3), USR(3), UST(3),
...
*  Isolate the radial component of the velocity (au/day).
      CALL iau_PN ( PV(1,1), W, PU )
      CALL iau_PDP ( PU, PV(1,2), VSR )
      CALL iau_SXP ( VSR, PU, USR )
...
*  Compute inertial radial velocity vector (au/d).
      CALL iau_SXP ( C*(D*BETSR+DEL), PU, UR )
