...
#   ===============
#
#   Version 5.2.0  Oct 29, 2021  Boris Semenov
#
#      Added options -std=legacy and -Wno-character-truncation.
#
...
if ( $?F_COMPILEOPTIONS ) then
   ...
   set F_COMPILEOPTIONS = "-m64 -fPIC -c -std=legacy -Wno-character-truncation"
   echo " "
